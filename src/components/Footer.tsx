...
const widgetMenus: WidgetFooterMenu[] = [
  {
    ...
    menus: [
      ...
      { href: "/account-savelists", label: "Yêu thích" },
  ...
  },
  {
    ...
    menus: [
      ...
      { href: "/term", label: "Điều khoản và điều kiện" },
  ...
  },
  {
    ...
    menus: [
      { href: "https://www.younghousehoalac.com/", label: "YoungHouse Hoà Lạc" },
      { href: "#", label: "SkyHome Hoà Lạc" },
      { href: "#", label: "Hoà Lạc Apartment" },
      { href: "#", label: "V Village" },
