...
const DEMO_CATS: TaxonomyType[] = [
  {
    ...
    taxonomy: "category",
    count: 17288,
    thumbnail: require("@/images/dh_fpt.jpeg").default.src,
  },
  {
    id: "2",
    href: "/phong-tro",
    ...
    taxonomy: "category",
    count: 2118,
    thumbnail: require("@/images/dh_hvtc.jpg").default.src,
  },
  {
    id: "3",
    href: "/phong-tro",
    ...
    taxonomy: "category",
    count: 36612,
    thumbnail: require("@/images/dh_qghn.png").default.src,
  },
  {
    id: "4",
    href: "/phong-tro",
    name: "Khu đô thị mới Hoà Lạc",
    taxonomy: "category",
    count: 18188,
    thumbnail:
...
const SectionSliderNewCategories: FC<SectionSliderNewCategoriesProps> = ({
  ...
  subHeading = "Discover amazing places around the world",
  className = "",
  itemClassName = "",
