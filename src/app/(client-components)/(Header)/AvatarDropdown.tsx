          ...
          <>
            ...
            >
              {user?.avatar ? (
                ...
                <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-primary-100 dark:bg-primary-900 flex items-center justify-center">
                ...
                <div className="overflow-hidden rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="relative grid grid-cols-1 gap-4 sm:gap-6 !bg-white dark:!bg-neutral-900 py-4 sm:py-7 px-4 sm:px-6">
                    <div className="flex items-center space-x-3">
                      {user?.avatar ? (
                        ...
                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-primary-100 dark:bg-primary-900 flex items-center justify-center">
                          <span className="text-lg sm:text-xl font-semibold text-primary-600 dark:text-primary-300">
                            {user.name?.charAt(0).toUpperCase() || user.email?.charAt(0).toUpperCase() || 'U'}
                          </span>
                        </div>
                      ) : (
                      ...
                      <div className="flex-grow min-w-0">
                        <h4 className="font-semibold text-sm sm:text-base truncate">{user?.name || user?.email || 'Guest'}</h4>
                        <p className="text-xs mt-0.5 truncate">{user?.email || 'Not logged in'}</p>
                      </div>
                    </div>

                    <div className="w-full border-b border-neutral-200 dark:border-neutral-700" />

                    <PortalQuickLinks role={user?.role} onNavigate={() => close()} />
                    ...
                    >
                      ...
                      <div className="ml-4">
                        <p className="text-sm font-medium ">{"Đơn đặt phòng"}</p>
                      </div>
                    </Link>
