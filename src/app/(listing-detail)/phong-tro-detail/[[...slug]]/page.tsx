...
const ListingStayDetailPage: FC<ListingStayDetailPageProps> = ({}) => {
  ...
  const renderSidebar = () => {
    // Extract price number from price string for BookingForm
    ...
    // Normalize owner phone: strip spaces/dots/dashes for tel/zalo links
      ...
      <div className="listingSectionSidebar__wrap shadow-xl">
        ...
        {hasOwnerPhone ? (
          <div className="flex gap-3 pb-4">
            ...
            >
              <Image src={ZaloIcon} alt="Zalo" width={18} height={18} className="object-contain" />
              Zalo
            </a>
        ...
        {roomData && (
          <BookingForm
            ...
            onSuccess={() => {
              ...
              alert("Đặt lịch xem phòng thành công! Chủ nhà sẽ liên hệ xác nhận với bạn.");
            }}
          />
        )}
      </div>
